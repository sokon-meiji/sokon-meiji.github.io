...
;	メニューボタン非表示
	...
	/* 画像類のパス */
	tf.img_path = '../others/plugin/theme_kopanda_08/image/config/';
...
;------------------------------------------------------------------------------------------------------
	...
	[iscript]
	if(tf.text_skip == 'OFF'){
		$(".unread_off").attr("src","data/others/plugin/theme_kopanda_08/image/config/skip_off.png");
		}else{
			$(".unread_on").attr("src","data/others/plugin/theme_kopanda_08/image/config/skip_on.png");
			}
	[endscript]
...
*skip_off
	...
	[iscript]
	$(".unread_off").attr("src","data/others/plugin/theme_kopanda_08/image/config/skip_off.png");
	$(".unread_on").attr("src","data/others/plugin/theme_kopanda_08/image/config/c_btn.gif");
	tf.text_skip = "OFF";
	[endscript]
...
*skip_on
	...
	[iscript]
	$(".unread_off").attr("src","data/others/plugin/theme_kopanda_08/image/config/c_btn.gif");
	$(".unread_on").attr("src","data/others/plugin/theme_kopanda_08/image/config/skip_on.png");
	tf.text_skip = "ON";
	[endscript]
