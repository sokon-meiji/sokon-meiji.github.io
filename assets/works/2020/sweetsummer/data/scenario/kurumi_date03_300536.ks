[_tb_system_call storage=system/_kurumi_date03_300536.ks]
...
[exglink3 number=1 target="チョコミントスムージー" text="チョコミントスムージー"]
[exglink3 number=2 target="スイカエスプレッソ" text="スイカエスプレッソ"]
[exglink3 number=3 target="ずんだ抹茶フラペチーノ" text="ずんだ抹茶フラペチーノ"]
[_tb_end_tyrano_code]
...
[jump  storage="kurumi_date03.ks"  target="*デート3分岐1終了"  ]
*スイカエスプレッソ
...
[tb_start_tyrano_code]
[call storage="macro.ks"]
[exglink3 number=1 target="不滅の刃" text="劇場版 不滅の刀"]
[exglink3 number=2 target="重い" text="重い、思われ、あり、あられ"]
[exglink3 number=3 target="大泣村" text="大泣村"]
[_tb_end_tyrano_code]
...
[jump  storage="kurumi_date03.ks"  target="*デート3分岐2終了"  ]
*重い
...
[mask  time="1000"  effect="fadeIn"  color="0x000000"  ]
[bg  time="1000"  method="crossfade"  storage="mall.jpg"  ]
[chara_show  name="kurumi"  time="750"  wait="true"  storage="chara/6/kurumi_shobo-n.png"  width="881"  height="500"  ]
[mask_off  time="1000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
#胡桃
いやぁ、まぁまぁでしたね。[p]
